...
public class Panel extends JPanel implements KeyListener {
    ...
    public void paint(Graphics g) {
        ...
        drawTanke(hero.getX() + 80,hero.getY(),g,hero.getDirect(),1);
        drawTanke(hero.getX() + 160,hero.getY(),g,hero.getDirect(),1);
        drawTanke(hero.getX() + 240,hero.getY(),g,hero.getDirect(),1);
    }
